...
public class NextParentTutorial2 : MonoBehaviour
{
    [SerializeField] private GameObject childObject;
    [SerializeField] public GameObject nextParent1; // First parent to activate
    [SerializeField] public GameObject nextParent2; // Second parent to activate
    ...
    private IEnumerator ActivateNextParentWithDelay()
    {
        ...
        // Deactivating the specified objects
